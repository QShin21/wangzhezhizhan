...
Fk:loadTranslationTable{
  ["wzzz_v__jiuzhu"] = "救主",
  [":wzzz_v__jiuzhu"] = "当己方一名其他角色处于濒死状态时，若你的体力值大于1，你可以弃置一张牌并失去1点体力，令该角色回复1点体力。",

  ["#wzzz_v__jiuzhu-invoke"] = "救主：你可以弃一张牌并失去1点体力，令 %dest 回复1点体力",
}
...
jiuzhu:addEffect(fk.AskForPeaches, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    local card = room:askToDiscard(player, {
      ...
      cancelable = true,
      prompt = "#wzzz_v__jiuzhu-invoke::" .. data.who,
      skip = true,
    })
    if #card > 0 then
