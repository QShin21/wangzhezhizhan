...
local fanjian = fk.CreateSkill{
  name = "wzzz_v__wzzz__fanjian",
}

Fk:loadTranslationTable{
  ["wzzz_v__wzzz__fanjian"] = "反间",
  [":wzzz_v__wzzz__fanjian"] = "出牌阶段限一次，你可以展示一张手牌，将之交给一名其他角色并令其本回合非锁定技失效，然后其需选择一项："..
  "1.展示所有手牌，并弃置与之颜色相同的所有牌（至少两张）；2.失去1点体力。",

  ["#wzzz_v__wzzz__fanjian"] = "反间：展示一张手牌并交给一名角色，其本回合非锁定技失效，选择弃牌或失去体力",
  ["@@wzzz_v__wzzz__fanjian-turn"] = "非锁定技失效",
  ["wzzz_v__wzzz__fanjian_show"] = "展示手牌，弃置所有%arg牌",

  ["$wzzz_v__wzzz__fanjian1"] = "与我为敌，就当这般生不如死！",
  ["$wzzz_v__wzzz__fanjian2"] = "抉择吧！在苦与痛的地狱中！",
}
...
fanjian:addEffect("active", {
  ...
  on_use = function(self, room, effect)
    ...
    room:setPlayerMark(target, "@@wzzz_v__wzzz__fanjian-turn", 1)
    local choices = { "wzzz_v__wzzz__fanjian_show:::" .. color, "loseHp" }
