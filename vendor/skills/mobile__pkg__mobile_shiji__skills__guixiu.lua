local guixiu = fk.CreateSkill {
  name = "wzzz_v__mobile__guixiu",
  tags = { Skill.Compulsory },
}

Fk:loadTranslationTable{
  ["wzzz_v__mobile__guixiu"] = "闺秀",
  [":wzzz_v__mobile__guixiu"] = "锁定技，结束阶段，若你的体力值为奇数，则你摸一张牌，否则你回复1点体力。",

  ["$wzzz_v__mobile__guixiu1"] = "身陷绝境，亦须秉端庄之姿。",
  ["$wzzz_v__mobile__guixiu2"] = "纵吾身罹乱，焉能隳节败名。",
}
