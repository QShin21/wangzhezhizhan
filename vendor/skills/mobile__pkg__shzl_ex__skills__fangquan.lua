local fangquan = fk.CreateSkill{
  name = "wzzz_v__m_ex__fangquan",
}

Fk:loadTranslationTable{
  ["wzzz_v__m_ex__fangquan"] = "放权",
  [":wzzz_v__m_ex__fangquan"] = "你可以跳过出牌阶段，若如此做，本回合你的手牌上限等于你的体力上限，且本回合结束后，你可以弃置一张手牌，令一名其他角色"..
  "获得一个额外回合。",

  ["$wzzz_v__m_ex__fangquan1"] = "爱卿自行定夺便是。",
  ["$wzzz_v__m_ex__fangquan2"] = "北伐事重，相父全权处理即可。",
}
