local tiaoxin = fk.CreateSkill{
  name = "wzzz_v__m_ex__tiaoxin",
}

Fk:loadTranslationTable{
  ["wzzz_v__m_ex__tiaoxin"] = "挑衅",
  [":wzzz_v__m_ex__tiaoxin"] = "出牌阶段限一次，你可以选择一名其他角色，然后除非该角色对你使用一张【杀】，否则你弃置其一张牌。",

  ["$wzzz_v__m_ex__tiaoxin1"] = "黄口竖子，何必上阵送命？",
  ["$wzzz_v__m_ex__tiaoxin2"] = "汝如欲大败而归，则可进军一战！",
}
