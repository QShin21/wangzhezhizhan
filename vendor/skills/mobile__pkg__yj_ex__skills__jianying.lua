...
Fk:loadTranslationTable{
  ...
  ["#wzzz_v__m_ex__jianying-active"] = "渐营：将一张牌转化为任意基本牌使用",
...
jianying:addEffect("viewas", {
  ...
  view_as = function(self, player, cards)
    ...
    local suit = player:getMark("wzzz_v__m_ex__jianying_suit-phase")
  ...
  before_use = function(self, player, use)
    player.room:setPlayerMark(player, "wzzz_v__m_ex__jianying_used-phase", 1)
  end,
  enabled_at_play = function(self, player)
    return player:getMark("wzzz_v__m_ex__jianying_used-phase") == 0
  end,
})
...
jianying:addLoseEffect(function(self, player)
  local room = player.room
  room:setPlayerMark(player, "wzzz_v__m_ex__jianying_used-phase", 0)
  room:setPlayerMark(player, "wzzz_v__m_ex__jianying_suit-phase", 0)
