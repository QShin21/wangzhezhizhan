local paiyi = fk.CreateSkill {
  name = "wzzz_v__m_ex__paiyi",
}

Fk:loadTranslationTable{
  ["wzzz_v__m_ex__paiyi"] = "排异",
  [":wzzz_v__m_ex__paiyi"] = "出牌阶段限一次，你可以移去一张“权”，令一名角色摸两张牌。若该角色的手牌数大于你，你对其造成1点伤害。",
  ["#wzzz_v__m_ex__paiyi-active"] = "排异：选择一张“权”牌置入弃牌堆并选择一名角色，令其摸两张牌",
  ["$wzzz_v__m_ex__paiyi1"] = "坏吾大计者，罪死不赦！",
  ["$wzzz_v__m_ex__paiyi2"] = "攻讦此子，祸咎已除！",
}

paiyi:addEffect("active", {
  name = "wzzz_v__m_ex__paiyi",
  anim_type = "control",
  prompt = "#wzzz_v__m_ex__paiyi-active",
