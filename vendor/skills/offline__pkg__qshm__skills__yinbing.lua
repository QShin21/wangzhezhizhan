...
Fk:loadTranslationTable{
  ...
  [":wzzz_v__qshm__yinbing"] = "结束阶段，你可以将任意名攻击范围内包含你的角色各一张手牌置于你的武将牌上。当你受到【杀】或【决斗】造成的伤害后，"..
  "伤害来源可以获得一张“引兵”牌。",

  ["$yinbing"] = "引兵",
  ["#wzzz_v__qshm__yinbing-choose"] = "引兵：你可以将任意任意名角色各一张手牌置为“引兵”牌",
  ["#wzzz_v__qshm__yinbing-prey"] = "引兵：你可以获得 %src 的一张“引兵”牌",
}
...
yinbing:addEffect(fk.Damaged, {
  ...
  on_cost = function (self, event, target, player, data)
    ...
    if room:askToSkillInvoke(data.from, {
      skill_name = yinbing.name,
      prompt = "#wzzz_v__qshm__yinbing-prey:"..player.id,
    }) then
