local hunzi = fk.CreateSkill {
  name = "wzzz_v__ol_ex__hunzi",
  tags = { Skill.Wake },
  related_skills = { "wzzz_v__ex__yingzi", "wzzz_v__yinghun" }
}

Fk:loadTranslationTable {
  ["wzzz_v__ol_ex__hunzi"] = "魂姿",
  [":wzzz_v__ol_ex__hunzi"] = "觉醒技，准备阶段，若你的体力值为1，你减1点体力上限，获得〖英姿〗和〖英魂〗。本回合结束阶段，你摸两张牌或回复1点体力。",

  ["$wzzz_v__ol_ex__hunzi1"] = "江东新秀，由此崛起。",
  ["$wzzz_v__ol_ex__hunzi2"] = "看汝等大展英气！",
}
...
hunzi:addEffect(fk.EventPhaseStart, {
  ...
  on_use = function(self, event, target, player, data)
    ...
    local choice = room:askToChoice(player, {
      ...
      prompt = "#wzzz_v__ol_ex__hunzi-choice",
    })
