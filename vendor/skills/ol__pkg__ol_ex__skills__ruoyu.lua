local ruoyu = fk.CreateSkill {
  name = "wzzz_v__ol_ex__ruoyu",
  tags = { Skill.Lord, Skill.Wake },
}

Fk:loadTranslationTable {
  ["wzzz_v__ol_ex__ruoyu"] = "若愚",
  [":wzzz_v__ol_ex__ruoyu"] = "主公技，觉醒技，准备阶段，若你是体力值最小的角色，你加1点体力上限，回复体力至3点，获得〖激将〗和〖思蜀〗。",

  ["$wzzz_v__ol_ex__ruoyu1"] = "若愚故泰，巧骗众人。",
  ["$wzzz_v__ol_ex__ruoyu2"] = "愚昧者，非真傻也。",
}
...
ruoyu:addEffect(fk.EventPhaseStart, {
  ...
  on_use = function(self, event, target, player, data)
    ...
    room:handleAddLoseSkills(player, "wzzz_v__ol_ex__jijiang|wzzz_v__sishu")
  end,
})
