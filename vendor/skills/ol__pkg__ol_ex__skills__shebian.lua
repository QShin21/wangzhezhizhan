local shebian = fk.CreateSkill {
  name = "wzzz_v__shebian",
}

Fk:loadTranslationTable{
  ["wzzz_v__shebian"] = "设变",
  [":wzzz_v__shebian"] = "当你翻面后，你可以移动场上一张装备牌。",

  ["#wzzz_v__shebian-choose"] = "设变：你可以移动场上一张装备牌",

  ["$wzzz_v__shebian1"] = "设变力战，虏敌千万！",
  ["$wzzz_v__shebian2"] = "随机应变，临机设变！",
}
