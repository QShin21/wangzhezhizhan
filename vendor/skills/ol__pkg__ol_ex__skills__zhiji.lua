local zhiji = fk.CreateSkill {
  name = "wzzz_v__ol_ex__zhiji",
  tags = { Skill.Wake },
}

Fk:loadTranslationTable {
  ["wzzz_v__ol_ex__zhiji"] = "志继",
  [":wzzz_v__ol_ex__zhiji"] = "觉醒技，准备阶段或结束阶段，若你没有手牌，你回复1点体力或摸两张牌，然后减1点体力上限，获得〖观星〗。",

  ["$wzzz_v__ol_ex__zhiji1"] = "丞相遗志，不死不休！",
  ["$wzzz_v__ol_ex__zhiji2"] = "大业未成，矢志不渝！",
}
