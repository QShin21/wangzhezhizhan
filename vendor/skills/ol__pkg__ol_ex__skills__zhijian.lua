...
local zhijian = fk.CreateSkill{
  name = "wzzz_v__ol_ex__zhijian",
}

Fk:loadTranslationTable {
  ["wzzz_v__ol_ex__zhijian"] = "直谏",
  [":wzzz_v__ol_ex__zhijian"] = "出牌阶段，你可以将一张装备牌置于其他角色装备区（替换原装备），然后摸一张牌。",

  ["#wzzz_v__ol_ex__zhijian"] = "直谏：将一张装备置入其他角色的装备区（替换原装备），摸一张牌",

  ["$wzzz_v__ol_ex__zhijian1"] = "君有恙，臣等当舍命除之。",
  ["$wzzz_v__ol_ex__zhijian2"] = "臣有言在喉，不吐不快。",
}

zhijian:addEffect("active", {
  anim_type = "support",
  prompt = "#wzzz_v__ol_ex__zhijian",
  card_num = 1,
  target_num = 1,
