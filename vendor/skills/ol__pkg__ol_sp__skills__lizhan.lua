...
Fk:loadTranslationTable{
  ["wzzz_v__lizhan"] = "励战",
  [":wzzz_v__lizhan"] = "结束阶段，你可以令任意名已受伤的角色摸一张牌。",

  ["#wzzz_v__lizhan-choose"] = "励战：你可以令任意名已受伤角色各摸一张牌",

  ["$wzzz_v__lizhan1"] = "敌军围困万千重，我自岿然不动。",
  ["$wzzz_v__lizhan2"] = "行伍严整，百战不殆。",
}
