...
Fk:loadTranslationTable{
  ["wzzz_v__hongde"] = "弘德",
  [":wzzz_v__hongde"] = "当你一次获得或失去至少两张牌后，你可以令一名其他角色摸一张牌。",

  ["#wzzz_v__hongde-choose"] = "弘德：你可以令一名其他角色摸一张牌",

  ["$wzzz_v__hongde1"] = "江南重义，东吴尚德。",
  ["$wzzz_v__hongde2"] = "德无单行，福必双至。",
}
