...
Fk:loadTranslationTable{
  ["wzzz_v__jixian"] = "急陷",
  [":wzzz_v__jixian"] = "摸牌阶段结束时，你可以视为对符合以下任意条件的一名其他角色使用一张【杀】并摸X张牌（X为其符合的条件数）："..
  "1.装备区里有防具牌；2.技能数多于你；3.未受伤。然后若此【杀】未造成伤害，你失去1点体力。",

  ["#wzzz_v__jixian-choose"] = "急陷：你可以视为使用【杀】并摸牌，若未造成伤害则失去1点体力",
  ["#wzzz_v__jixian_tip"] = "摸%arg张牌",

  ["$wzzz_v__jixian1"] = "全军出击，速攻敌城。",
  ["$wzzz_v__jixian2"] = "勿以我为念，攻城！",
}
