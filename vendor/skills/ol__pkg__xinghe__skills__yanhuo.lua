...
Fk:loadTranslationTable{
  ...
  [":wzzz_v__ol__yanhuo"] = "当你死亡时，你可以弃置杀死你的角色至多X张牌（X为你的牌数）。",

  ["#wzzz_v__ol__yanhuo-invoke"] = "延祸：你可以弃置 %dest 至多%arg张牌",
...
yanhuo:addEffect(fk.Death, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    if room:askToSkillInvoke(player, {
      ...
      prompt = "#wzzz_v__ol__yanhuo-invoke::"..data.killer.id..":"..#player:getCardIds("he"),
    }) then
