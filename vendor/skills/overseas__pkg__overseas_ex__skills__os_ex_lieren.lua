local osExLieren = fk.CreateSkill {
  name = "wzzz_v__os_ex__lieren"
}

Fk:loadTranslationTable{
  ["wzzz_v__os_ex__lieren"] = "烈刃",
  [":wzzz_v__os_ex__lieren"] = "当你使用【杀】指定目标后，你可以与其拼点，若你赢，你获得其一张牌；若你没赢，你获得其拼点的牌，其获得你拼点的牌。",

  ["#wzzz_v__os_ex__lieren-invoke"] = "烈刃：你可以与 %src 点，若赢，你获得其一张牌，若没赢，你们获得对方拼点牌",

  ["$wzzz_v__os_ex__lieren1"] = "有我手中飞刀在，何惧蜀军！",
  ["$wzzz_v__os_ex__lieren2"] = "长矛，飞刀，烈火，都来吧！"
}
  ...
  on_cost = function (self, event, target, player, data)
    return player.room:askToSkillInvoke(
      player,
      {
        ...
        prompt = "#wzzz_v__os_ex__lieren-invoke:" .. data.to.id,
      }
    )
  end,
