...
Fk:loadTranslationTable{
  ["wzzz_v__quhu"] = "驱虎",
  [":wzzz_v__quhu"] = "出牌阶段限一次，你可以与一名体力值大于你的角色拼点。若你赢，该角色对其攻击范围内你指定的另一名角色造成1点伤害；若你没赢，"..
  "其对你造成1点伤害。",

  ["#wzzz_v__quhu"] = "驱虎：与一名角色拼点，若赢，其对你指定的角色造成伤害，若没赢，其对你造成伤害",
  ["#wzzz_v__quhu-choose"] = "驱虎：选择其攻击范围内的一名角色，其对此角色造成1点伤害",

  ["$wzzz_v__quhu1"] = "此乃驱虎吞狼之计。",
  ["$wzzz_v__quhu2"] = "借你之手，与他一搏吧。",
}
