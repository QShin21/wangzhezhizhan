...
Fk:loadTranslationTable{
  ["wzzz_v__haoshi"] = "好施",
  [":wzzz_v__haoshi"] = "摸牌阶段，你可以多摸两张牌，然后若你的手牌数大于5，你将半数（向下取整）手牌交给手牌牌最少的一名其他角色。",

  ["#wzzz_v__haoshi-give"] = "好施：将%arg张手牌交给手牌最少的一名其他角色",

  ["$wzzz_v__haoshi1"] = "拿去拿去，莫跟哥哥客气！",
  ["$wzzz_v__haoshi2"] = "来来来，见面分一半。",
}
