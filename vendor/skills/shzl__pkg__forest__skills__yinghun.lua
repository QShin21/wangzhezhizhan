...
Fk:loadTranslationTable{
  ["wzzz_v__yinghun"] = "英魂",
  [":wzzz_v__yinghun"] = "准备阶段，若你已受伤，你可以选择一名其他角色并选择一项：1.令其摸X张牌，然后弃置一张牌；2.令其摸一张牌，然后弃置X张牌"..
  "（X为你已损失的体力值）。",

  ["#wzzz_v__yinghun-choose"] = "英魂：你可以令一名其他角色：摸%arg张牌然后弃置一张牌，或摸一张牌然后弃置%arg张牌",
...
yinghun:addEffect(fk.EventPhaseStart, {
  ...
  on_use = function(self, event, target, player, data)
    ...
    local choices = {"#wzzz_v__yinghun-draw:::" .. n, "#wzzz_v__yinghun-discard:::" .. n}
