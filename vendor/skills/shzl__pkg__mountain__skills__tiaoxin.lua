local tiaoxin = fk.CreateSkill {
  name = "wzzz_v__tiaoxin",
}

Fk:loadTranslationTable{
  ["wzzz_v__tiaoxin"] = "挑衅",
  [":wzzz_v__tiaoxin"] = "出牌阶段限一次，你可以指定一名你在其攻击范围内的角色，其需包括你在内的角色使用一张【杀】，否则你弃置其一张牌。",

  ["#wzzz_v__tiaoxin"] = "挑衅：令一名角色对你使用一张【杀】，否则你弃置其一张牌",
  ["#wzzz_v__tiaoxin-use"] = "挑衅：对 %src 使用一张【杀】，否则其弃置你一张牌",

  ["$wzzz_v__tiaoxin1"] = "汝等小儿，可敢杀我？",
  ["$wzzz_v__tiaoxin2"] = "贼将早降，可免一死。",
}
...
tiaoxin:addEffect("active", {
  ...
  on_use = function(self, room, effect)
    ...
    local use = room:askToUseCard(target, {
      ...
      pattern = "slash",
      prompt = "#wzzz_v__tiaoxin-use:"..player.id,
      extra_data = {
