...
Fk:loadTranslationTable{
  ["wzzz_v__zuilun"] = "罪论",
  [":wzzz_v__zuilun"] = "结束阶段，你可以观看牌堆顶三张牌，你每满足以下一项便获得其中的一张，然后以任意顺序放回其余的牌：1.你于此回合内造成过伤害；"..
  "2.你于此回合内未弃置过牌；3.手牌数为全场最少。若均不满足，你与一名其他角色失去1点体力。",

  ["#wzzz_v__zuilun-invoke"] = "罪论：你可以观看牌堆顶3张牌，保留%arg张，放回其余的牌",
  ["#wzzz_v__zuilun-choose"] = "罪论：选择一名其他角色，你与其各失去1点体力",

  ["$wzzz_v__zuilun1"] = "吾有三罪，未能除黄皓、制伯约、守国土。",
  ["$wzzz_v__zuilun2"] = "唉，数罪当论，吾愧对先帝恩惠。",
}
...
zuilun:addEffect(fk.EventPhaseStart, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    if room:askToSkillInvoke(player, {
      ...
      prompt = "#wzzz_v__zuilun-invoke:::"..n,
    }) then
