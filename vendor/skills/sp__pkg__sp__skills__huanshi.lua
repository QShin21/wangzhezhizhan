local huanshi = fk.CreateSkill {
  name = "wzzz_v__huanshi",
}

Fk:loadTranslationTable{
  ["wzzz_v__huanshi"] = "缓释",
  [":wzzz_v__huanshi"] = "当一名角色的判定牌生效前，你可以令该角色观看你的手牌并选择你的一张牌，你打出此牌代替之。",

  ["#wzzz_v__huanshi-invoke"] = "缓释：你可以令 %dest 观看你的手牌，打出你的一张牌修改其“%arg”判定",

  ["$wzzz_v__huanshi1"] = "缓乐之危急，释兵之困顿。",
  ["$wzzz_v__huanshi2"] = "尽死生之力，保友邦之安。",
}
...
huanshi:addEffect(fk.AskForRetrial, {
  ...
  on_cost = function(self, event, target, player, data)
    if player.room:askToSkillInvoke(player, {
      ...
      prompt = "#wzzz_v__huanshi-invoke::"..target.id..":"..data.reason
    }) then
