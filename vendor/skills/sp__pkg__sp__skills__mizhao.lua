...
Fk:loadTranslationTable {
  ["wzzz_v__mizhao"] = "密诏",
  [":wzzz_v__mizhao"] = "出牌阶段限一次，你可以将所有手牌（至少一张）交给一名其他角色。若如此做，你令该角色与你指定的另一名有手牌的其他角色拼点，"..
  "视为拼点赢的角色对没赢的角色使用一张【杀】。",

  ["#wzzz_v__mizhao"] = "密诏：将所有手牌交给一名角色，令其与另一名角色拼点",
  ["#wzzz_v__mizhao-choose"] = "密诏：选择与 %dest 拼点的角色，赢者视为对没赢者使用【杀】",

  ["$wzzz_v__mizhao1"] = "爱卿世受皇恩，堪此重任。",
  ["$wzzz_v__mizhao2"] = "此诏事关重大，切记小心行事。",
}

mizhao:addEffect("active", {
  anim_type = "control",
  prompt = "#wzzz_v__mizhao",
  card_num = 0,
  target_num = 1,
  ...
  on_use = function(self, room, effect)
    ...
    local to = room:askToChoosePlayers(player, {
      ...
      max_num = 1,
      targets = targets,
      prompt = "#wzzz_v__mizhao-choose::"..target.id,
      cancelable = false,
    })[1]
