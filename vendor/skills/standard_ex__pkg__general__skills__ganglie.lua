Fk:loadTranslationTable{
  ...
  [":wzzz_v__ex__ganglie"] = "当你受到1点伤害后，你可以判定，若结果为：红色，你对来源造成1点伤害；黑色，你弃置来源的一张牌。",

  ["#wzzz_v__ex__ganglie-invoke"] = "刚烈：是否对 %dest 发动“刚烈”进行判定，红色对其造成伤害，黑色弃置其牌",
  ...
  on_cost = function(self, event, target, player, data)
    ...
    if data.from and not data.from.dead then
      if room:askToSkillInvoke(player, {
        ...
        prompt = "#wzzz_v__ex__ganglie-invoke::"..data.from.id,
      }) then
