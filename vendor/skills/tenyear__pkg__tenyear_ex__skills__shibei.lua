local shibei = fk.CreateSkill {
  name = "wzzz_v__ty_ex__shibei",
  tags = { Skill.Compulsory },
}

Fk:loadTranslationTable{
  ["wzzz_v__ty_ex__shibei"] = "矢北",
  [":wzzz_v__ty_ex__shibei"] = "锁定技，你每回合受到第一次伤害后，你回复1点体力；你每回合受到第二次伤害后，你失去1点体力。",

  ["$wzzz_v__ty_ex__shibei1"] = "主公在北，吾心亦在北！",
  ["$wzzz_v__ty_ex__shibei2"] = "宁向北而死，不面南而生。",
}
