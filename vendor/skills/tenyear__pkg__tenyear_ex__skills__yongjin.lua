...
Fk:loadTranslationTable{
  ...
  ["$wzzz_v__ty_ex__yongjin1"] = "鏖兵卫主，勇足以却敌！",
  ["$wzzz_v__ty_ex__yongjin2"] = "勇不可挡，进则无退！",
}

yongjin:addEffect("active", {
  anim_type = "offensive",
  prompt = "#wzzz_v__ty_ex__yongjin",
  card_num = 0,
  target_num = 0,
  ...
  on_use = function(self, room, effect)
    ...
    for _ = 1, 3 do
      ...
      local tos = room:askToChooseToMoveCardInBoard(player, {
        ...
        flag = "e",
        prompt = "#wzzz_v__ty_ex__yongjin-choose",
        cancelable = true,
        no_indicate = false,
