local kuangfu = fk.CreateSkill {
  name = "wzzz_v__ty__kuangfu",
}

Fk:loadTranslationTable{
  ["wzzz_v__ty__kuangfu"] = "狂斧",
  [":wzzz_v__ty__kuangfu"] = "出牌阶段限一次，你可以弃置场上的一张装备牌，视为使用一张【杀】（无距离次数限制）。"..
  "若弃置的不是你的牌且此【杀】未造成伤害，你弃置两张手牌；若弃置的是你的牌且此【杀】造成伤害，你摸两张牌。",

  ["#wzzz_v__ty__kuangfu"] = "狂斧：弃置一名角色一张的装备，视为使用一张无距离次数限制的【杀】",
  ["#wzzz_v__ty__kuangfu-slash"] = "狂斧：视为使用一张【杀】",

  ["$wzzz_v__ty__kuangfu1"] = "大斧到处，片甲不留！",
  ["$wzzz_v__ty__kuangfu2"] = "你可接得住我一斧？",
}

kuangfu:addEffect("active", {
  anim_type = "offensive",
  prompt = "#wzzz_v__ty__kuangfu",
  card_num = 0,
  target_num = 1,
  ...
  on_use = function(self, room, effect)
    ...
    local use = room:askToUseVirtualCard(player, {
      name = "slash",
      skill_name = kuangfu.name,
      prompt = "#wzzz_v__ty__kuangfu-slash",
      cancelable = true,
      extra_data = {
