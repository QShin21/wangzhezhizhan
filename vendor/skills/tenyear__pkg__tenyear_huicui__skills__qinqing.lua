...
Fk:loadTranslationTable{
  ...
  [":wzzz_v__ty__qinqing"] = "结束阶段，你可以弃置攻击范围内含有一号位的一名其他角色的一张牌，然后若其手牌数比一号位多，你摸一张牌。",

  ["#wzzz_v__ty__qinqing-choose"] = "寝情：弃置一名角色一张牌，然后若其手牌数多于 %dest，你摸一张牌",
...
qinqing:addEffect(fk.EventPhaseStart, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    local to = room:askToChoosePlayers(player, {
      ...
      min_num = 1,
      max_num = 1,
      prompt = "#wzzz_v__ty__qinqing-choose::"..room:getPlayerBySeat(1).id,
