local juyi = fk.CreateSkill {
  name = "wzzz_v__ty_ex__juyi",
  tags = { Skill.Wake },
}

Fk:loadTranslationTable{
  ["wzzz_v__ty_ex__juyi"] = "举义",
  [":wzzz_v__ty_ex__juyi"] = "觉醒技，准备阶段，若你已受伤且体力上限大于存活角色数，你将手牌摸至体力上限，然后获得技能〖崩坏〗和〖威重〗。",

  ["$wzzz_v__ty_ex__juyi1"] = "举义旗，兴王师，伐不臣！",
  ["$wzzz_v__ty_ex__juyi2"] = "逆贼篡国，天下义士当共讨之！",
}
...
juyi:addEffect(fk.EventPhaseStart, {
  ...
  on_use = function(self, event, target, player, data)
    ...
    player.room:handleAddLoseSkills(player, "wzzz_v__benghuai|wzzz_v__ty_ex__weizhong")
  end,
})
