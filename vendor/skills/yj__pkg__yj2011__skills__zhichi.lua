...
Fk:loadTranslationTable{
  ...
  ["$wzzz_v__zhichi1"] = "如今之计，唯有退守，再做决断。",
  ["$wzzz_v__zhichi2"] = "若吾，早知如此……",
}
...
zhichi:addEffect(fk.Damaged, {
  ...
  on_use = function(self, event, target, player, data)
    player.room:setPlayerMark(player, "@@wzzz_v__zhichi-turn", 1)
  end,
})
...
zhichi:addTest(function (room, me)
  ...
  FkTest.runInRoom(function() room:handleAddLoseSkills(comp2, "wzzz_v__zhichi") end)
