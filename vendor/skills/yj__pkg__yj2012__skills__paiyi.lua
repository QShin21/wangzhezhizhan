...
Fk:loadTranslationTable{
  ["wzzz_v__paiyi"] = "排异",
  [":wzzz_v__paiyi"] = "出牌阶段限一次，你可以将一张“权”置入弃牌堆，令一名角色摸两张牌，然后若该角色的手牌数大于你的手牌数，你对其造成1点伤害。",

  ["#wzzz_v__paiyi"] = "排异：移去一张“权”，令一名角色摸两张牌，然后若其手牌数大于你，对其造成1点伤害",

  ["$wzzz_v__paiyi1"] = "妨碍我的人，都得死！",
  ["$wzzz_v__paiyi2"] = "此地容不下你！",
}

paiyi:addEffect("active", {
  anim_type = "control",
  prompt = "#wzzz_v__paiyi",
  card_num = 1,
  target_num = 1,
