...
Fk:loadTranslationTable{
  ["wzzz_v__faen"] = "法恩",
  [":wzzz_v__faen"] = "当一名角色的武将牌翻至正面朝上或横置后，你可以令其摸一张牌。",

  ["#wzzz_v__faen-invoke"] = "法恩：你可以令 %dest 摸一张牌",

  ["$wzzz_v__faen1"] = "王法威仪，恩泽天下。",
  ["$wzzz_v__faen2"] = "法外有情，恩威并举。",
}
...
local spec = {
  on_cost = function(self, event, target, player, data)
    ...
    if room:askToSkillInvoke(player, {
      ...
      prompt = "#wzzz_v__faen-invoke::"..target.id,
    }) then
