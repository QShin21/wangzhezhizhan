...
Fk:loadTranslationTable{
  ["wzzz_v__jishe"] = "极奢",
  [":wzzz_v__jishe"] = "出牌阶段，若你的手牌上限大于0，你可以摸一张牌，然后本回合你的手牌上限-1；结束阶段，若你没有手牌，你可以横置至多X名角色"..
  "（X为你的体力值）。",

  ["#wzzz_v__jishe"] = "极奢：摸一张牌，本回合手牌上限-1",
  ["#wzzz_v__jishe-choose"] = "极奢：你可以横置至多%arg名角色",

  ["$wzzz_v__jishe1"] = "孙吴正当盛世，兴些土木又何妨？",
  ["$wzzz_v__jishe2"] = "当再建新殿，扬我国威！",
}

jishe:addEffect("active", {
  anim_type = "drawcard",
  prompt = "#wzzz_v__jishe",
  card_num = 0,
  target_num = 0,
...
jishe:addEffect(fk.EventPhaseStart, {
  ...
  on_cost = function(self, event, target, player, data)
    ...
    local tos = room:askToChoosePlayers(player, {
      ...
      max_num = player.hp,
      targets = targets,
      prompt = "#wzzz_v__jishe-choose:::"..player.hp,
      cancelable = true,
    })
    if #tos > 0 then
